...
public open class AESContext : RefCounted() {
  ...
  /**
   * Start the AES context in the given [param mode]. A [param key] of either 16 or 32 bytes must always be provided, while an [param iv] (initialization vector) of exactly 16 bytes, is only needed when [param mode] is either [MODE_CBC_ENCRYPT] or [MODE_CBC_DECRYPT].
   */
  public fun start(
  ...
  /**
   * Run the desired operation for this AES context. Will return a [godot.PackedByteArray] containing the result of encrypting (or decrypting) the given [param src]. See [start] for mode of operation.
   *
